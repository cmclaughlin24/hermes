...
import { DeliveryWindowEntity } from './delivery-window.entity';
...
export class UserEntity {
  ...
  @OneToMany(() => DeliveryWindowEntity, (window) => window.user, { cascade: true })
  deliveryWindows?: DeliveryWindowEntity[];
