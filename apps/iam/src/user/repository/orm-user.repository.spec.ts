...
import { DeliveryWindowEntity } from './entities/delivery-window.entity';
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: getRepositoryToken(DeliveryWindowEntity),
          useValue: createMockRepository<DeliveryWindowEntity>(),
        },
      ],
    }).compile();

    repository = module.get<OrmUserRepository>(OrmUserRepository);
    userModel = module.get<MockRepository>(getRepositoryToken(UserEntity));
  });
